...
if (microBlogJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/devops-cloudbees-ci/pipeline-template-catalog.git");
        ...
        <instance>
          ...
          <values class="tree-map">
            <entry>
              ...
              <string>workshop.labs.cb-sa.io</string>
            </entry>
            <entry>
            ...
            <entry>
              <string>name</string>
              <string>devops-cloudbees-ci</string>
            </entry>
            <entry>
    ...
    <sources>
      <jenkins.branch.BranchSource plugin="branch-api@2.5.5">
        <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
          ...
          <repoOwner>devops-cloudbees-ci</repoOwner>
